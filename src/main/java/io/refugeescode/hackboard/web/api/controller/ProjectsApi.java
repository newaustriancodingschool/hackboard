...
public interface ProjectsApi {
    ...
    default ResponseEntity<List<ProjectDto>> listProjects() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("[ {  \"ownerLastName\" : \"ownerLastName\",  \"roles\" : [ {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  }, {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  } ],  \"description\" : \"description\",  \"id\" : 0,  \"ownerFirstName\" : \"ownerFirstName\",  \"title\" : \"title\",  \"ownerId\" : 6}, {  \"ownerLastName\" : \"ownerLastName\",  \"roles\" : [ {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  }, {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  } ],  \"description\" : \"description\",  \"id\" : 0,  \"ownerFirstName\" : \"ownerFirstName\",  \"title\" : \"title\",  \"ownerId\" : 6} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    default ResponseEntity<ProjectDto> viewProject(@ApiParam(value = "ID of project",required=true) @PathVariable("projectId") Long projectId) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"ownerLastName\" : \"ownerLastName\",  \"roles\" : [ {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  }, {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  } ],  \"description\" : \"description\",  \"id\" : 0,  \"ownerFirstName\" : \"ownerFirstName\",  \"title\" : \"title\",  \"ownerId\" : 6}", ProjectDto.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
