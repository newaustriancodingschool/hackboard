...
public interface ProjectsApi {
    ...
    default ResponseEntity<List<ProjectDto>> listProjects() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("[ {  \"project_story\" : [ \"project_story\", \"project_story\" ],  \"ApplicationDto\" : [ {    \"project_id\" : 5,    \"role_id\" : 2,    \"applicant\" : 5  }, {    \"project_id\" : 5,    \"role_id\" : 2,    \"applicant\" : 5  } ],  \"ownerLastName\" : \"ownerLastName\",  \"github\" : \"github\",  \"projectRole\" : [ {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  }, {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  } ],  \"description\" : \"description\",  \"id\" : 0,  \"ownerFirstName\" : \"ownerFirstName\",  \"title\" : \"title\",  \"ownerId\" : 6}, {  \"project_story\" : [ \"project_story\", \"project_story\" ],  \"ApplicationDto\" : [ {    \"project_id\" : 5,    \"role_id\" : 2,    \"applicant\" : 5  }, {    \"project_id\" : 5,    \"role_id\" : 2,    \"applicant\" : 5  } ],  \"ownerLastName\" : \"ownerLastName\",  \"github\" : \"github\",  \"projectRole\" : [ {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  }, {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 1  } ],  \"description\" : \"description\",  \"id\" : 0,  \"ownerFirstName\" : \"ownerFirstName\",  \"title\" : \"title\",  \"ownerId\" : 6} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
