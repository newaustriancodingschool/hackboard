...
public interface ProjectsApi {
    ...
    default ResponseEntity<List<ProjectDto>> listProjects() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("[ {  \"project_story\" : [ \"project_story\", \"project_story\" ],  \"ownerLastName\" : \"ownerLastName\",  \"github\" : \"github\",  \"projectRole\" : [ {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 5,    \"id\" : 1  }, {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 5,    \"id\" : 1  } ],  \"applicationDto\" : [ {    \"roleId\" : 9,    \"roleColor\" : \"roleColor\",    \"applicantFullName\" : \"applicantFullName\",    \"roleName\" : \"roleName\",    \"id\" : 5,    \"projectId\" : 7,    \"applicant\" : 2,    \"userGithub\" : \"userGithub\"  }, {    \"roleId\" : 9,    \"roleColor\" : \"roleColor\",    \"applicantFullName\" : \"applicantFullName\",    \"roleName\" : \"roleName\",    \"id\" : 5,    \"projectId\" : 7,    \"applicant\" : 2,    \"userGithub\" : \"userGithub\"  } ],  \"description\" : \"description\",  \"ownerLoginName\" : \"ownerLoginName\",  \"id\" : 0,  \"ownerFirstName\" : \"ownerFirstName\",  \"title\" : \"title\",  \"ownerId\" : 6}, {  \"project_story\" : [ \"project_story\", \"project_story\" ],  \"ownerLastName\" : \"ownerLastName\",  \"github\" : \"github\",  \"projectRole\" : [ {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 5,    \"id\" : 1  }, {    \"color\" : \"color\",    \"roleName\" : \"roleName\",    \"count\" : 5,    \"id\" : 1  } ],  \"applicationDto\" : [ {    \"roleId\" : 9,    \"roleColor\" : \"roleColor\",    \"applicantFullName\" : \"applicantFullName\",    \"roleName\" : \"roleName\",    \"id\" : 5,    \"projectId\" : 7,    \"applicant\" : 2,    \"userGithub\" : \"userGithub\"  }, {    \"roleId\" : 9,    \"roleColor\" : \"roleColor\",    \"applicantFullName\" : \"applicantFullName\",    \"roleName\" : \"roleName\",    \"id\" : 5,    \"projectId\" : 7,    \"applicant\" : 2,    \"userGithub\" : \"userGithub\"  } ],  \"description\" : \"description\",  \"ownerLoginName\" : \"ownerLoginName\",  \"id\" : 0,  \"ownerFirstName\" : \"ownerFirstName\",  \"title\" : \"title\",  \"ownerId\" : 6} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
